!function(e, t) {
    ...
    function E(e) {
        var t = G,
            n = Ue[e];
        return n || (n = k(e, t), "none" !== n && n || (Ye = (Ye || oe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Ye[0].contentDocument, t.write(), t.close(), n = k(e, t), Ye.detach()), Ue[e] = n), n
    }
    function S(e, t, n) {
        var r,
            i,
            ...
            s,
            a = e.style;
        return n = n || Qe(e), s = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== s && void 0 !== s || oe.contains(e.ownerDocument, e) || (s = oe.style(e, t)), n && !re.pixelMarginRight() && Ge.test(s) && Ve.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o), void 0 !== s ? s + "" : s
    }
    function N(e, t) {
        return {
            get: function() {
    ...
    function q(t, n, r) {
        ...
        if (G.msFullscreenElement && e.top !== e && t.getClientRects().length && (o = Math.round(100 * t.getBoundingClientRect()[n])), 0 >= o || null == o) {
            if (o = S(t, n, s), (0 > o || null == o) && (o = t.style[n]), Ge.test(o))
                return o;
    ...
    function M(e, t, n) {
        ...
        for (I(c, l.opts.specialEasing); s > o; o++)
            if (r = M.prefilters[o].call(l, e, c, l.opts))
                return oe.isFunction(r.stop) && (oe._queueHooks(l.elem, l.opts.queue).stop = oe.proxy(r.stop, r)), r;
    ...
    var ce = function(e) {
            ...
            if (!r && ((t ? t.ownerDocument || t : W) !== L && q(t), t = t || L, O)) {
                ...
                if (w.qsa && !z[e + " "] && (!F || !F.test(e))) {
                    if (1 !== g)
                        ...
                        for ((a = t.getAttribute("id")) ? a = a.replace(xe, "\\$&") : t.setAttribute("id", a = M), f = E(e), o = f.length, u = pe.test(a) ? "#" + a : "[id='" + a + "']"; o--;)
                            f[o] = u + " " + p(f[o]);
        ...
        function d(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                if (s) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || i) {
                            if (l = t[M] || (t[M] = {}), u = l[t.uniqueID] || (l[t.uniqueID] = {}), (a = u[r]) && a[0] === $ && a[1] === o)
                                return c[2] = a[2];
            ...
            var i = n.length > 0,
                ...
                s = function(r, s, a, u, l) {
                    var c,
                        ...
                        w = x.length;
                    for (l && (A = s === L || s || l); h !== w && null != (c = x[h]); h++) {
                        if (o && c) {
        ...
        w = t.support = {}, k = t.isXML = function(e) {
            ...
            return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, H = L.documentElement, O = !k(L), (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), w.attributes = i(function(e) {
                ...
                return H.appendChild(e).id = M, !L.getElementsByName || !L.getElementsByName(M).length
            ...
            }), F = F.length && new RegExp(F.join("|")), P = P.length && new RegExp(P.join("|")), t = me.test(H.compareDocumentPosition), I = t || me.test(H.contains) ? function(e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === W && I(W, e) ? -1 : t === L || t.ownerDocument === W && I(W, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t)
                    return j = !0, 0;
                var n,
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                for (p = m, f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === $ && l[1], x = d && l[2], p = d && m.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop();)
                                    if (1 === p.nodeType && ++x && p === t) {
                                        c[e] = [$, d, x];
                                        break
                                    }
                            } else if (y && (p = t, f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === $ && l[1], x = d), x === !1)
                                for (; (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++x || (y && (f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), c[e] = [$, x]), p !== t));)
                                    ;
        ...
        }, w.sortStable = M.split("").sort(Y).join("") === M, w.detectDuplicates = !!j, q(), w.sortDetached = i(function(e) {
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                if (o && void 0 === t) {
                    if (n = Se.get(o, e) || Se.get(o, e.replace(Ae, "-$&").toLowerCase()), void 0 !== n)
                        return n;
                    if (r = oe.camelCase(e), n = Se.get(o, r), void 0 !== n)
                        return n;
    ...
    oe.event = {
        ...
        fix: function(e) {
            ...
            var t,
                ...
                o = e,
                s = this.fixHooks[i];
            for (s || (this.fixHooks[i] = s = Me.test(i) ? this.mouseHooks : Ie.test(i) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, e = new oe.Event(o), t = r.length; t--;)
                n = r[t], e[n] = o[n];
    ...
    oe.Animation = oe.extend(M, {
        ...
        tweener: function(e, t) {
            ...
            for (var n, r = 0, i = e.length; i > r; r++)
                n = e[r], M.tweeners[n] = M.tweeners[n] || [], M.tweeners[n].unshift(t)
        },
        prefilters: [R],
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : oe.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    ...
                    void 0 !== e && "boolean" !== n || (t = W(this), t && Ee.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : Ee.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t,
    ...
    At.href = mt.href, oe.extend({
        ...
        ajax: function(t, n) {
            ...
            if (g.promise(T).complete = m.add, T.success = T.done, T.error = T.fail, p.url = ((t || p.url || mt.href) + "").replace(xt, "").replace(kt, mt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = oe.trim(p.dataType || "*").toLowerCase().match(we) || [""], null == p.crossDomain) {
                l = G.createElement("a");
                try {
                    l.href = p.url, l.href = l.href, p.crossDomain = At.protocol + "//" + At.host != l.protocol + "//" + l.host
                } catch (C) {
                    p.crossDomain = !0
                }
            }
            if (p.data && p.processData && "string" != typeof p.data && (p.data = oe.param(p.data, p.traditional)), B(Et, p, n, T), 2 === b)
                return T;
...
_APP = function() {
    var e = this;
    return e.__construct = function() {
        $(".hi").on({
            mouseenter: function() {
                $(".layout_pop-up").addClass("is-active"), $(".layout_pop-up > span").addClass("is-active")
            },
            mouseleave: function() {
                $(".layout_pop-up").removeClass("is-active"), $(".layout_pop-up > span").removeClass("is-active")
            }
        }), $(".rotate").textrotator({
            animation: "dissolve",
            separator: ",",
